"""
Chronos-2 LoRA V1/V2/V3/V4 vs Statistical Models
================================================

Purpose
-------
Evaluate the four financially fine-tuned Chronos-2 LoRA adapters against
...
V4:
    models/chronos2-finance-lora-v4-equity-rates-vol/finetuned-ckpt
...
RESULTS_DIR = BASE_DIR / "results_lora_4models"
